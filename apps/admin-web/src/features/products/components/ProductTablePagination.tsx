...
import type { ProductTableControlActions, ProductTableControlState, ProductTableViewState } from '../products-table.types'

type ProductTablePaginationProps = {
  actions: ProductTableControlActions
  controls: ProductTableControlState
  view: Pick<ProductTableViewState, 'filteredCount' | 'from' | 'pageCount' | 'to'>
}

export function ProductTablePagination({ actions, controls, view }: ProductTablePaginationProps) {
